...
public class Edit_employes_page_text_page extends VBox {
    public Edit_employes_page_text_page() throws FileNotFoundException {
        ...
        apply_butto.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/uni_project","root" , "") ;
                    PreparedStatement statement = connection.prepareStatement("UPDATE management_employees_page_text SET text = ? WHERE id = 0 ") ;
