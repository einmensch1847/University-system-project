...
public class Edit_professors_info extends VBox{
    public Edit_professors_info() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        Edit_professors_info_page editProfessorsInfoPage = null;
                        try {
                            editProfessorsInfoPage = new Edit_professors_info_page(id , name , last_name , user_name , password_ , phone_number , email , address);
                        } catch (FileNotFoundException e) {
                            throw new RuntimeException(e);
                        }
                        Stage stage1 = new Stage() ;
                        stage1.setScene(new Scene(editProfessorsInfoPage));
                        stage1.show();
