...
import model.student_dormitory_page_controller;

import java.io.FileInputStream;
import java.io.FileNotFoundException;
import java.sql.SQLException;

public class student_dormitory_page extends VBox {
    public student_dormitory_page() throws FileNotFoundException {
        ...
        fatherNameLabel.setStyle("-fx-font-size: 14 ; -fx-text-fill: rgb(255,255,255)");
        ...
        sendButton.setStyle("-fx-font-size: 18px; -fx-font-family: Arial; -fx-background-color: rgba(80,93,155,0.62); -fx-background-radius: 10px; -fx-text-fill: rgb(255,255,255)");
        ...
        Label headerLabel = new Label("\" students dormitory \"");
        ...
        sendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    student_dormitory_page_controller studentDormitoryPageController = new student_dormitory_page_controller();
                    studentDormitoryPageController.student_dormitory_page_controllerr(
                    ...
                    student_dormitory_page_controller.close();
