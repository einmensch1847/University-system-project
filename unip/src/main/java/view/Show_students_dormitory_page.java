...
public class Show_students_dormitory_page extends VBox{
    public Show_students_dormitory_page() {
        VBox vBox = new VBox();
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM student_dormitory_request");
