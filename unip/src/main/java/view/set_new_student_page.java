...
public class set_new_student_page extends VBox {
    ...
    private TextField postal_code_TextField, address_TextField, tuition_TextField, age_TextField, debt_TextField;
    private DatePicker date_of_birth;
    private Label registration_label;
    private Button send_button, Exit_button;

    public set_new_student_page() throws FileNotFoundException {
        setupUI();
        setupActions();
    }
    ...
    private void setupUI() throws FileNotFoundException {
        ...
        VBox vBox1 = new VBox(name_label, lastname_label, username_label, password_label, field_label, student_number_label,
                ...
                tuition_label, age_label, debt_label);
        ...
        VBox vBox2 = new VBox(name_TextField, lastname_TextField, username_TextField, password_TextField, field_TextField,
                ...
                address_TextField, tuition_TextField, age_TextField, debt_TextField);
    ...
    private void handleRegistration() {
        set_new_student_controller backend = new set_new_student_controller();
        ...
        try {
            success = backend.registerStudent(name_TextField.getText(), lastname_TextField.getText(), username_TextField.getText(),
                    ...
                    Integer.parseInt(age_TextField.getText()), Integer.parseInt(debt_TextField.getText()));
