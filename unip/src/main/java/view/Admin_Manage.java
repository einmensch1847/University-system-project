...
public class Admin_Manage extends VBox{
    public Admin_Manage() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        Admin_manage_page adminManagePage = null;
                        try {
                            adminManagePage = new Admin_manage_page(salary , id , name , last_name , username , password , phone_number , postal_code , address);
                        } catch (FileNotFoundException e) {
                            throw new RuntimeException(e);
                        }
                        Stage stage1 = new Stage() ;
                        stage1.setScene(new Scene(adminManagePage));
                        stage1.show();
