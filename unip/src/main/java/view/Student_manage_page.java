...
import model.Student_manage_page_controller;

import java.io.FileInputStream;
import java.io.FileNotFoundException;
import java.sql.SQLException;

public class Student_manage_page extends VBox {
    ...
    public Student_manage_page(int debt, int id, String name, String lastname, String Username, String password, String phone_number, String postal_code, String address) throws FileNotFoundException {
        final_id = id;
        final_name = name;
        ...
        Label Debt = new Label("debt: ");
        TextField textField = new TextField(String.valueOf(debt));
        ...
        VBox vbox = new VBox(Debt, textField, send_button);
        ...
        send_button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    Student_manage_page_controller dbHandler = new Student_manage_page_controller();
                    dbHandler.updateStudent(final_id, final_name, final_last_name, final_username, final_password, final_phone_number, final_postal_code, final_address, Integer.parseInt(textField.getText()));
