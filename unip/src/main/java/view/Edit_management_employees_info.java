...
public class Edit_management_employees_info extends VBox {
    public Edit_management_employees_info() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        Edit_management_employees_info_page adminPanel = null;
                        try {
                            adminPanel = new Edit_management_employees_info_page(name , last_name , phone_number , email , username , password , id);
