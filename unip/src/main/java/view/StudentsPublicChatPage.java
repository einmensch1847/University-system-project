...
public class StudentsPublicChatPage extends VBox{
    private GridPane gridPane;
    private int row;
    public StudentsPublicChatPage() throws FileNotFoundException {
        ...
        sendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    statement.setString(4 , "GREEN");
                    statement.executeUpdate();
                    connection.close();

                    addMessageToGrid(row++, messageField.getText(), simpleDateFormat1.format(date) , "GREEN");
                    messageField.clear();
