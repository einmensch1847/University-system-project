...
public class profesor_employee_manage extends VBox{
    public profesor_employee_manage() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        profesor_employee_manage_page profesorEmployeeManagePage = null;
                        try {
                            profesorEmployeeManagePage = new profesor_employee_manage_page(basic_salary , id , name , last_name , user_name , password_ , phone_number , email , address);
                        } catch (FileNotFoundException e) {
                            throw new RuntimeException(e);
                        }
                        Stage stage1 = new Stage() ;
                        stage1.setScene(new Scene(profesorEmployeeManagePage));
                        stage1.show();
