...
public class Edit_students_info extends VBox {
    public Edit_students_info() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        String email = resultSet.getString("postal_code") ;
                        String address = resultSet.getString("address") ;
                        int id = resultSet.getInt("id") ;

                        Edit_students_info_page Edit_students_info_page = null;
                        try {
                            Edit_students_info_page = new Edit_students_info_page(id , name , last_name , user_name , password_ , phone_number , email , address);
                        } catch (FileNotFoundException e) {
                            throw new RuntimeException(e);
                        }
                        Stage stage1 = new Stage() ;
                        stage1.setScene(new Scene(Edit_students_info_page));
                        stage1.show();
