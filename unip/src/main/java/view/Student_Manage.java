...
public class Student_Manage extends VBox{
    public Student_Manage() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        Student_manage_page studentManagePage = null;
                        try {
                            studentManagePage = new Student_manage_page(debt , id , name , last_name , user_name , password_ , phone_number , email , address);
