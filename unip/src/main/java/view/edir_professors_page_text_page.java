...
public class edir_professors_page_text_page extends VBox{
    public edir_professors_page_text_page() throws FileNotFoundException {
...
//                stage1.show();
        ...
        apply_butto.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/uni_project","root" , "") ;
                    PreparedStatement statement = connection.prepareStatement("UPDATE professors_page_text SET text = ? WHERE id = 0 ") ;
