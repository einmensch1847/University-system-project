...
import model.AdmissionRequest;

import java.io.FileInputStream;
import java.io.FileNotFoundException;
import java.sql.SQLException;

public class AdmissionRequestPage extends VBox {
    public AdmissionRequestPage() throws FileNotFoundException {
        ...
        nationalityLabel.setStyle("-fx-font-size: 13 ; -fx-text-fill: rgb(255,255,255)");
        Label countryLabel = new Label("country : ");
        countryLabel.setStyle("-fx-font-size: 13 ; -fx-text-fill: rgb(255,255,255)");
        Label reasonLabel = new Label("the reason for the request : ");
        reasonLabel.setStyle("-fx-font-size: 13 ; -fx-text-fill: rgb(255,255,255)");
        ...
        VBox labelBox1 = new VBox(nameLabel, lastnameLabel, phoneNumberLabel, emailLabel, fatherNameLabel, ageLabel, nationalityLabel, countryLabel);
        labelBox1.setAlignment(Pos.CENTER);
        labelBox1.setSpacing(16);
        ...
        nationalityTextField.setStyle("-fx-background-color: rgba(226,226,229,0.45) ;-fx-background-radius: 10px;");
        TextField countryTextField = new TextField();
        countryTextField.setStyle("-fx-background-color: rgba(226,226,229,0.45) ;-fx-background-radius: 10px;");
        ...
        VBox textFieldBox1 = new VBox(nameTextField, lastnameTextField, phoneNumberTextField, emailTextField, fatherNameTextField, ageTextField, nationalityTextField, countryTextField);
        ...
        mainBox.setPrefSize(330, 500);
        mainBox.setAlignment(Pos.CENTER);
        mainBox.setStyle("-fx-background-color:rgba(67,65,65,0.45); -fx-background-radius: 10px;");
//        mainBox.setLayoutX(106);
//        mainBox.setLayoutY(240);

        Label headerLabel = new Label("\" ADMISSION REQUEST \"");
        headerLabel.setStyle("-fx-font-size: 20; -fx-text-fill: rgba(14,76,86,0.75); -fx-font-family: BordeauxHeavy ");
//        headerLabel.setLayoutX(163);
//        headerLabel.setLayoutY(90);

        VBox vBox = new VBox(headerLabel , mainBox) ;
        vBox.setSpacing(20);
        ...
        sendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    admissionRequest.insertAdmissionRequest(
