...
public class Edit_contact_us_page extends VBox {
    public Edit_contact_us_page() throws FileNotFoundException {
...
//                stage1.show();
        ...
        apply_butto.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/uni_project","root" , "") ;
                    PreparedStatement statement = connection.prepareStatement("UPDATE communication_with_the_university SET text = ? WHERE id = 0 ") ;
