...
public class ProfessorsPublicChatPage extends VBox {
    private GridPane gridPane;
    private int row;
    public ProfessorsPublicChatPage() throws FileNotFoundException {
        ...
        sendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    statement.setString(4 , "BLUE");
                    statement.executeUpdate();
                    connection.close();

                    addMessageToGrid(row++, messageField.getText(), simpleDateFormat1.format(date) , "BLUE");
                    messageField.clear();
