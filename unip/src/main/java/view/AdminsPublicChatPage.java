...
public class AdminsPublicChatPage extends VBox{
    private GridPane gridPane;
    private int row;
    public AdminsPublicChatPage() throws FileNotFoundException {
        ...
        sendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    statement.setString(4 , "GOLD");
                    statement.executeUpdate();
                    connection.close();

                    addMessageToGrid(row++, messageField.getText(), simpleDateFormat1.format(date) , "GOLD");
                    messageField.clear();
