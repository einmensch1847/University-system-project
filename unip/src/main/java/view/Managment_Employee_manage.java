...
public class Managment_Employee_manage extends VBox{
    public Managment_Employee_manage() throws FileNotFoundException {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    if (resultSet.next()){
                        ...
                        Managment_Employee_manage_page managmentEmployeeManagePage = null;
                        try {
                            managmentEmployeeManagePage = new Managment_Employee_manage_page(salary , name , last_name , phone_number , email , username , password , id);
                        } catch (FileNotFoundException e) {
                            throw new RuntimeException(e);
                        }
                        Stage stage1 = new Stage() ;
                        stage1.setScene(new Scene(managmentEmployeeManagePage));
                        stage1.show();
